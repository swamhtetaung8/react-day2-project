  ...
  return (
    <div className="bg-light">
      ...
      <div className="container mt-5 pt-5">
        <div className="d-flex flex-wrap justify-content-center align-items-center my-3 gap-5">
            ...
            <div
              ...
              <div className="card-body">
                <img
                  ...
                  alt=""
                />
                <h4 className=" my-3 text-truncate">{product.title}</h4>
                <p className=" text-black-50 text-truncate">
                  {product.description}
                </p>
                <div className="d-flex align-items-center justify-content-between">
                  <p className="badge bg-success mb-0 py-2 fs-6">
                    $ {product.price}
                  </p>
